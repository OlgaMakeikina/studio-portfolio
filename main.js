...
const portfolioData = [
  ...
  { 
    ...
    description: "Современный корпоративный сайт с каталогом помещений",
    badge: "Завершен",
    gradient: "linear-gradient(135deg, #dc2626 0%, #ef4444 50%, #f87171 100%)",
    image: "media/delta/storage.jpg",
    tags: ["Редизайн", "Корпоративный сайт", "Каталог"],
    details: { 
      challenge: "Редизайн устаревшего сайта компании аренды складских помещений с сохранением существующего контента и фотоматериалов", 
      solution: "Разработали современный дизайн с улучшенной структурой, адаптивной версткой и удобной навигацией по каталогу складских помещений", 
      result: "Повышение пользовательского опыта, современный внешний вид, сохранение всех материалов и информации" 
    } 
  },
  { 
    id: 6, 
...
const processSteps = [
  { 
    ...
    bullets:[
      "Изучаем вашу нишу, конкурентов и целевую аудиторию",
      "Определяем цели проекта: продажи, брендинг, автоматизация",
      "Собираем функциональные и технические требования",
      "Согласовываем сроки, этапы и точки контроля"
    ] 
  },
  { 
    number: 2,
    title:"Смета и варианты", 
    bullets:[
      "Предлагаем варианты реализации под ваш бюджет",
      "Детализируем стоимость каждого этапа работ",
      "Показываем, что входит в базовый пакет и что можно добавить",
      "Прозрачная структура оплаты: поэтапно или фиксированная цена"
    ] 
  },
  { 
    number: 3,
    ...
    bullets:[
      "Создаём дизайн: UI-kit, цвета, шрифты, стиль компонентов",
      "Верстаем адаптивный интерфейс под все разрешения экранов",
      "Программируем функционал: формы, интеграции, личные кабинеты",
      "Тестируем на реальных устройствах и браузерах",
      "Проверяем доступность, скорость загрузки и SEO-оптимизацию"
    ] 
  },
  { 
    number: 4,
    ...
    bullets:[
      "Переносим контент, настраиваем хостинг и домен",
      "Подключаем аналитику, метрики и системы отслеживания",
      "Проверяем доступность, скорость загрузки и SEO-оптимизацию",
      "Предоставляем SLA-поддержку: обновления, правки, мониторинг"
    ] 
  }
];
